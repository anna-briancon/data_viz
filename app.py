...
app.layout = dbc.Container([
   ...
   html.H2("1 - Contexte", className='mb-4 mt-5 text-center'),
    dbc.Col([
        ...
        html.P("Tornado Alley est une région des États-Unis où les tornades sont fréquentes. Elle s'étend du nord du Texas au Dakota du Sud, en passant par l'Oklahoma, le Kansas et le Nebraska."),
